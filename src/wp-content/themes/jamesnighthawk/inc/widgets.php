<?php
/**
 * Makes a custom Widget for displaying Aside, Link, Status, and Quote Posts available with black label creative
 *
 ...
 */
class black_label_creative_Ephemera_Widget extends WP_Widget {
	 ...
	 * @return void
	 **/
	function black_label_creative_Ephemera_Widget() {
		$widget_ops = array( 'classname' => 'widget_blacklabelcreative_ephemera', 'description' => __( 'Use this widget to list your recent Aside, Status, Quote, and Link posts', 'twentyeleven' ) );
		$this->WP_Widget( 'widget_blacklabelcreative_ephemera', __( 'black label creative Ephemera', 'twentyeleven' ), $widget_ops );
		$this->alt_option_name = 'widget_blacklabelcreative_ephemera';
	...
	function widget( $args, $instance ) {
		$cache = wp_cache_get( 'widget_blacklabelcreative_ephemera', 'widget' );
		...
		wp_cache_set( 'widget_blacklabelcreative_ephemera', $cache, 'widget' );
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['widget_blacklabelcreative_ephemera'] ) )
			delete_option( 'widget_blacklabelcreative_ephemera' );

		return $instance;
	}

	function flush_widget_cache() {
		wp_cache_delete( 'widget_blacklabelcreative_ephemera', 'widget' );
	}
